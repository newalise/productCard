        ...
        <div className="container">
            ...
            <section className="product">
                <ul className="product_list">
                    <Card city="Москва" price="10 000" name="Название товара1"/>
                    <Card city="Новосибирск" price="15 010" name="Название товара2"/>
                    <Card city="Братск" price="18 500" name="Название товара3"/>
                </ul>
            </section>
        </div>
    </div>
